    ...
    <>
      <div className="text-[11px] text-[#777]">
        <p className="mb-3 ">
          ...
          <a
            id="password-forgot"
            className=" text-blue-900 font-semibold cursor-pointer focus:text-[#385898] pointer  mx-1"
          >
            En savoir plus.
          </a>
        </p>
        <p className="mb-3">
          ...
          <a className=" text-[#385898] font-semibold cursor-pointer focus:text-[#385898] pointer mx-1">
