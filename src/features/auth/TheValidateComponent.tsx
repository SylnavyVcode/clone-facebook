...
import TheResetPasswordComponent from "./TheResetPasswordComponent";
...
function ValidateComponent() {
  ...
  return (
    <>
                ...
                <div className="w-full">
                  ...
                  >
                    ...
                    <div id="reset_password_step_1">
                      <p className="py-2">
                        S'il vous plait vérifier votre email pour confirmer
                        votre code. Votre code est long de 6 nombres.
                      </p>
      ...
      {switchToResetPassword && (
        <TheResetPasswordComponent CODE={code}></TheResetPasswordComponent>
      )}
    </>
  );
}
